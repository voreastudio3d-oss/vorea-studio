// Vorea Studio — Threaded Jar
// Functional storage jar with matching threaded lid
// Compatible: Vorea Studio SCAD Engine

body_d = 74;          // [36:2:140] Diametro exterior del frasco
jar_h = 82;           // [30:2:180] Altura total del frasco
wall = 2.4;           // [1.2:0.2:6] Grosor de pared
floor = 3;            // [1.2:0.2:8] Espesor de base
neck_h = 16;          // [8:0.5:36] Altura de zona roscada
thread_pitch = 4;     // [2:0.2:8] Paso de la rosca
thread_turns = 2.5;   // [1:0.25:5] Vueltas de la rosca
thread_depth_nominal = 1.75; // [0.8:0.05:4] Altura radial visible de la rosca
thread_clearance = 0.35; // [0.1:0.05:1.2] Holgura radial de rosca
fit_slop = 0.12;      // [0:0.02:0.6] Compensacion extra por material/slicer
lead_in = 1.2;          // [0.4:0.1:4] Guiado de entrada
lid_h = 20;           // [10:0.5:40] Altura de la tapa
lid_clearance = 0.6;  // [0.2:0.05:1.6] Holgura entre tapa y frasco
lid_knurl = 18;       // [0:1:36] Nervios exteriores de agarre
