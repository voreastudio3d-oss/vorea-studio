// Vorea Studio — Peg Label System
// Functional workshop/storage label with front text and rear clips
...
text_size = 8.5;    // [4:0.5:20] Tamano del texto
text_depth = 1;     // [0.4:0.1:3] Relieve o grabado
border_w = 1.6;     // [0.6:0.2:5] Ancho del marco
hook_gap = 4.2;     // [1.5:0.2:12] Espesor del soporte
hook_depth = 8;     // [4:0.5:20] Profundidad del clip
hook_drop = 12;     // [6:0.5:32] Caida del clip
hook_spacing = 42;  // [18:1:120] Separacion entre clips
label_text = "BITS";
primary_text = "BITS";
secondary_text = "";
line_count = 1;
